...
playerBountyKillBuffer = 5 * 60 * 1000 -- Buffer before player bounty can be put back on terminal after target is killed, set 0 to disable

playerBountyDebuffLength = 5 * 60 * 1000 -- Time before their bounty resets from the minimum amount
