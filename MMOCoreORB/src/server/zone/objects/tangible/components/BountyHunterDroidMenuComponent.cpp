...
bool BountyHunterDroidMenuComponent::playerCanUseTrack(CreatureObject* player) const {
	return player->hasSkill("combat_bountyhunter_investigation_03") || player->hasSkill("force_title_jedi_rank_03");
}

bool BountyHunterDroidMenuComponent::playerCanUseDroids(CreatureObject* player) const {
	return player->hasSkill("combat_bountyhunter_investigation_01") || player->hasSkill("force_title_jedi_rank_03");
}
